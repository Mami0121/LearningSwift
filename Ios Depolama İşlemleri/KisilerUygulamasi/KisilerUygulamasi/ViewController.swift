...
class ViewController: UIViewController {
    ...
    let context = appDelegate.persistentContainer.viewContext  // veritanında veri kayıt işlemleri- silme ve güncelleme için işimize yarıyo
...
extension ViewController:UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let kisi = kisilerListe[indexPath.row] // k.liste içindeki veriyi almak için
        ...
        // hücrede ne yazılmasını istiyorsak onu belirtiyoruz
